...
class ProductCatalog {
  ...
  List<CatalogProduct> search(String query, {int limit = 6}) {
    ...
    for (final product in products) {
      ...
      if (productKey.startsWith(key)) score += 70;
      if (productKey.contains(key)) score += 55;
      if (key.contains(productKey)) score += 45;
      score += queryTokens.intersection(productTokens).length * 20;
